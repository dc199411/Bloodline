...
export function useDangerAgents() {
  ...
  return {
    data: Array.isArray(result.data.agents) ? result.data.agents : MOCK_AGENTS.filter((a) => a.stage === "danger"),
    loading: result.loading,
    error: result.error
  };
}
...
export function useLeaderboard() {
  ...
  return {
    data: Array.isArray(result.data.leaderboard) ? result.data.leaderboard : fallback,
    loading: result.loading,
    error: result.error
  };
}
